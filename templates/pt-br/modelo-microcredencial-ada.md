...
Este modelo foi projetado para ajudá-lo a **criar micro-credenciais modulares e prontas para o trabalho**. Cada seção inclui **\[instruções entre colchetes]** para que você possa adaptá-lo ao seu domínio.
...
\[Defina 3–5 objetivos usando **verbos da taxonomia de Bloom**. Cada um será apoiado por Átomos de Aprendizado.]
...
| Átomo  | Objetivo        | Conceito (Ler/Escutar/Assistir)        | Exemplo               | Prática                  | Avaliar                              |   |
| ------ | --------------- | --------------------------------------- | --------------------- | ------------------------ | ------------------------------------ | - |
| Átomo 1| \[Objetivo #1]  | \[Artigo, guia, vídeo, podcast]        | \[Estudo de caso ou demo] | \[Mini-laboratório ou exercício] | \[Questionário, reflexão, mini-rubrica] |   |
| Átomo 2| \[Objetivo #2]  | …                                       | …                     | …                        | …                                    | … |
...
* Aplicação prática e pronta para o trabalho.
