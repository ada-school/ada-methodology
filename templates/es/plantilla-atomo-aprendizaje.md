## ⚛ Átomo de Aprendizaje: *\[Nombre del Átomo]*

### 🎯 Objetivo de Aprendizaje 

* *\[Establece el objetivo usando un verbo de acción de la Taxonomía de Bloom, ej., Analizar, Implementar, Diseñar, Evaluar, etc.]*
...
* *\[Lista el conocimiento previo, habilidades o conceptos necesarios para participar exitosamente con este átomo]*

---

### 🧭 Descripción del Átomo

* *\[Describe brevemente el propósito del átomo, su contexto y su relevancia para el desarrollo profesional]*

---

### 📚 Contenido Clave

* *\[Lista los conceptos, técnicas o herramientas que se cubrirán]*

    * [ ] Concepto 1.
    * [ ] Concepto 2.
    * [ ] Técnica/Herramienta 1.
...
* *\[Tipo de resultado: código, visualización, análisis, informe, etc.]*
* *Criterios de aceptación o rúbrica básica para evaluar el trabajo*

---

### 🧩 Conexiones con Otros Átomos

* **Predecesores:** *\[Menciona átomos que deben completarse primero]*
* **Sucesores:** *\[Menciona átomos que siguen a este]*

---

### 🧠 Reflexión Final

* *\[Incluye una pregunta o indicación para estimular la reflexión metacognitiva]*
  Ejemplo: ¿Cómo podrías aplicar esta técnica en un contexto profesional del mundo real?

---

### ✅ Lista de Verificación para Validación del Facilitador

* [ ] El objetivo se alinea con la competencia objetivo.
* [ ] Las actividades son aplicadas y contextualizadas.
* [ ] La evaluación es clara y basada en criterios.
* [ ] Los recursos son actuales y accesibles.
