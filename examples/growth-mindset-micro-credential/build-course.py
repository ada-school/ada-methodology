#!/usr/bin/env python3
"""Build a self-contained interactive course.html for the Growth Mindset micro-credential.
...
(brand-themed, with graceful fallback), and copy-able image-generation prompts.
...
PAGES = [
    ...
    ("atoms/atom-1-science-of-mindset.md",     "atom-1",    "1 · The science of mindset", "🙉 Phase 1 · hear"),
    ("atoms/atom-2-myths-and-nuance.md",       "atom-2",    "2 · Myths & nuance",         "🙈 Phase 2 · see"),
    ("atoms/atom-3-power-of-yet.md",           "atom-3",    "3 · The power of yet",        "🙈 Phase 2 · see"),
    ("atoms/atom-4-deliberate-practice-lab.md","atom-4",    "4 · Deliberate-practice lab", "🙊 Phase 3 · do"),
    ("atoms/atom-5-failure-resume-feedback.md","atom-5",    "5 · Failure résumé & feedback","🙊 Phase 3 · do"),
    ("atoms/atom-6-growth-in-the-wild-capstone.md","atom-6","6 · Growth in the wild 🚀",   "🐵 Phase 4 · share"),
...
<title>🌱 Growth Mindset · ADA Micro-Credential</title>
...
<div class="app">
  <aside class="side" id="side">
    <div class="brand">
      ...
      <div><b>Growth Mindset</b><small>ADA MICRO-CREDENTIAL</small></div>
    </div>
    <div class="progwrap">
  ...
  <div class="main">
    <div class="topbar">
      ...
      <span class="pill">🌱 Growth Mindset Practitioner</span>
      <span class="sp"></span>
...
(function(){
  ...
  var KEY="ada-growth-mindset-progress";
