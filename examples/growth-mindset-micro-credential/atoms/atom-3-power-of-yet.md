...
```mermaid
flowchart LR
  N1["1 · NAME<br/>the fixed thought"] --> N2["2 · ADD 'yet'<br/>reframe the claim"]
  N2 --> N3["3 · CHOOSE<br/>one strategy / source of help"]
  N3 --> N4["4 · ACT<br/>smallest next step"]
  N4 -. repeat on next wall .-> N1
```
