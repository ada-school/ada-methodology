#!/usr/bin/env python3
"""Build a self-contained interactive course.html for the Self-Learning micro-credential.
...
PAGES = [
    ...
    ("atoms/atom-1-how-learning-works.md",                       "atom-1",    "1 · How learning works",          "🙉 Phase 1 · hear"),
    ("atoms/atom-2-trust-sources-and-how-ai-works.md",          "atom-2",    "2 · Sources & how AI works",      "🙉 Phase 1 · hear"),
    ("atoms/atom-3-research-with-search.md",                     "atom-3",    "3 · Research with search",        "🙈 Phase 2 · see"),
    ("atoms/atom-4-learn-with-ai.md",                            "atom-4",    "4 · Learn with AI 🛠️",            "🙊 Phase 3 · do"),
    ("atoms/atom-5-self-learning-loop.md",                       "atom-5",    "5 · The self-learning loop 🛠️",   "🙊 Phase 3 · do"),
    ("atoms/atom-6-capstone-learn-something-new.md",             "atom-6",    "6 · Capstone 🚀",                 "🐵 Phase 4 · share"),
...
COURSE_REL = "examples/self-learning-micro-credential"  # course root, relative to repo root
...
<title>🧭 Self-Learning · ADA Micro-Credential</title>
...
<div class="app">
  <aside class="side" id="side">
    <div class="brand">
      ...
      <div><b>Self-Learning</b><small>ADA MICRO-CREDENTIAL</small></div>
    </div>
    <div class="progwrap">
...
(function(){
  ...
  var KEY="self-learning-progress";
