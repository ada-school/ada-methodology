#!/usr/bin/env python3
"""Build a self-contained interactive course.html for the Effective Communication micro-credential.
...
PAGES = [
    ...
    ("atoms/atom-1-how-communication-works.md",                  "atom-1",    "1 · How communication works",     "🙉 Phase 1 · hear"),
    ("atoms/atom-2-audience-and-channel.md",                     "atom-2",    "2 · Audience & channel",          "🙉 Phase 1 · hear"),
    ("atoms/atom-3-active-listening.md",                         "atom-3",    "3 · Active listening",            "🙈 Phase 2 · see"),
    ("atoms/atom-4-structure-your-message.md",                   "atom-4",    "4 · Structure your message 🛠️",   "🙊 Phase 3 · do"),
    ("atoms/atom-5-feedback-and-difficult-conversations.md",     "atom-5",    "5 · Feedback & hard talks 🛠️",    "🙊 Phase 3 · do"),
    ("atoms/atom-6-communication-capstone.md",                   "atom-6",    "6 · Capstone 🚀",                 "🐵 Phase 4 · share"),
...
COURSE_REL = "examples/effective-communication-micro-credential"  # course root, relative to repo root
...
<title>🗣️ Effective Communication · ADA Micro-Credential</title>
...
<div class="app">
  <aside class="side" id="side">
    <div class="brand">
      ...
      <div><b>Effective Communication</b><small>ADA MICRO-CREDENTIAL</small></div>
    </div>
    <div class="progwrap">
  ...
  <div class="main">
    <div class="topbar">
      ...
      <span class="pill">🗣️ Effective Communication</span>
      <span class="sp"></span>
...
(function(){
  ...
  var KEY="effective-communication-progress";
