#!/usr/bin/env python3
"""Build a self-contained interactive course.html for the Python Variables micro-credential.

Reads the course Markdown files and emits a single, dependency-free HTML file that works from
file:// — sidebar navigation, phase progress, embedded YouTube (click-to-play), Mermaid diagrams
(brand-themed, with graceful fallback), syntax-tagged code blocks, and copy-able prompts.
...
PAGES = [
    ...
    ("atoms/atom-1-what-is-a-variable.md",                   "atom-1",    "1 · What is a variable?",         "🙉 Phase 1 · hear"),
    ("atoms/atom-2-data-types.md",                           "atom-2",    "2 · Data types & typing",         "🙈 Phase 2 · see"),
    ("atoms/atom-3-naming-and-assignment-codelab.md",        "atom-3",    "3 · Naming & assignment 💻",      "🙊 Phase 3 · do"),
    ("atoms/atom-4-expressions-conversion-fstrings-codelab.md","atom-4",  "4 · Expressions & f-strings 💻",  "🙊 Phase 3 · do"),
    ("atoms/atom-5-mini-project-capstone.md",                "atom-5",    "5 · Mini-project 🚀",             "🐵 Phase 4 · share"),
    ("labs.md",                                              "labs",      "Labs & tests 🧪",                 "💻 Code & tests"),
...
ATOM_IDS = ["atom-1", "atom-2", "atom-3", "atom-4", "atom-5"]

PATH2ID = {p[0]: p[1] for p in PAGES}          # course file path -> in-app page id
COURSE_REL = "examples/python-variables-micro-credential"  # course root, relative to repo root
...
<title>🐍 Python Variables · ADA Micro-Credential</title>
...
<div class="app">
  <aside class="side" id="side">
    <div class="brand">
      ...
      <div><b>Python Variables</b><small>ADA MICRO-CREDENTIAL</small></div>
    </div>
    <div class="progwrap">
      <div class="progbar"><div class="progfill" id="progfill"></div></div>
      <div class="progtext" id="progtext">0 / 5 atoms complete</div>
    </div>
    <nav id="nav">{{NAV}}</nav>
  </aside>
  <div class="main">
    <div class="topbar">
      ...
      <span class="pill">🐍 Python Variables Foundations</span>
      <span class="sp"></span>
...
(function(){
  ...
  var atomIds=["atom-1","atom-2","atom-3","atom-4","atom-5"];
  var idx=0;
  ...
  var KEY="ada-python-variables-progress";
