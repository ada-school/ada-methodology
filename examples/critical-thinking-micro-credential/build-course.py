#!/usr/bin/env python3
"""Build a self-contained interactive course.html for the Critical Thinking micro-credential.
...
PAGES = [
    ...
    ("atoms/atom-1-what-is-critical-thinking.md",            "atom-1",    "1 · What critical thinking is",   "🙉 Phase 1 · hear"),
    ("atoms/atom-2-fallacies-and-biases.md",                 "atom-2",    "2 · Fallacies & biases",          "🙉 Phase 1 · hear"),
    ("atoms/atom-3-evaluate-arguments-and-evidence.md",      "atom-3",    "3 · Evaluate arguments 🛠️",       "🙈 Phase 2 · see"),
    ("atoms/atom-4-question-and-verify.md",                  "atom-4",    "4 · Question & verify 🛠️",        "🙊 Phase 3 · do"),
    ("atoms/atom-5-build-and-defend-an-argument.md",         "atom-5",    "5 · Build & defend 🛠️",           "🙊 Phase 3 · do"),
    ("atoms/atom-6-capstone-reason-through-a-real-issue.md", "atom-6",    "6 · Capstone 🚀",                 "🐵 Phase 4 · share"),
...
COURSE_REL = "examples/critical-thinking-micro-credential"  # course root, relative to repo root
...
<title>🧠 Critical Thinking · ADA Micro-Credential</title>
...
<div class="app">
  <aside class="side" id="side">
    <div class="brand">
      ...
      <div><b>Critical Thinking</b><small>ADA MICRO-CREDENTIAL</small></div>
    </div>
    <div class="progwrap">
...
(function(){
  ...
  var KEY="critical-thinking-progress";
