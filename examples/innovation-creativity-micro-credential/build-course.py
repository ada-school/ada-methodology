#!/usr/bin/env python3
"""Build a self-contained interactive course.html for the Innovation & Creativity micro-credential.
...
PAGES = [
    ...
    ("atoms/atom-1-what-is-creativity-and-innovation.md",      "atom-1",    "1 · What it is",                  "🙉 Phase 1 · hear"),
    ("atoms/atom-2-ideation-frameworks.md",                    "atom-2",    "2 · Ideation frameworks",         "🙉 Phase 1 · hear"),
    ("atoms/atom-3-reframe-problems-and-spot-opportunities.md","atom-3",    "3 · Reframe & spot 🛠️",           "🙈 Phase 2 · see"),
    ("atoms/atom-4-generate-ideas.md",                         "atom-4",    "4 · Generate ideas 🛠️",           "🙊 Phase 3 · do"),
    ("atoms/atom-5-develop-prototype-and-evaluate.md",         "atom-5",    "5 · Develop & prototype 🛠️",      "🙊 Phase 3 · do"),
    ("atoms/atom-6-capstone-innovation-challenge.md",          "atom-6",    "6 · Capstone 🚀",                 "🐵 Phase 4 · share"),
...
COURSE_REL = "examples/innovation-creativity-micro-credential"  # course root, relative to repo root
...
<title>💡 Innovation & Creativity · ADA Micro-Credential</title>
...
<div class="app">
  <aside class="side" id="side">
    <div class="brand">
      ...
      <div><b>Innovation & Creativity</b><small>ADA MICRO-CREDENTIAL</small></div>
    </div>
    <div class="progwrap">
  ...
  <div class="main">
    <div class="topbar">
      ...
      <span class="pill">💡 Innovation & Creativity</span>
      <span class="sp"></span>
...
(function(){
  ...
  var KEY="innovation-creativity-progress";
