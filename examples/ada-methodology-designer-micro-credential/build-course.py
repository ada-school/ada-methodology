#!/usr/bin/env python3
"""Build a self-contained interactive course.html for the ADA Methodology Designer micro-credential.
...
fallback), syntax-tagged code blocks, and copy-able prompts.
...
PAGES = [
    ...
    ("atoms/atom-1-the-ada-big-picture.md",                "atom-1",    "1 · The ADA big picture",        "🙉 Phase 1 · hear"),
    ("atoms/atom-2-ksa-in-depth.md",                       "atom-2",    "2 · KSA in depth",               "🙉 Phase 1 · hear"),
    ("atoms/atom-3-blooms-taxonomy-objectives.md",         "atom-3",    "3 · Bloom & objectives",         "🙉 Phase 1 · hear"),
    ("atoms/atom-4-learning-atom-topology.md",             "atom-4",    "4 · Atom topology",              "🙈 Phase 2 · see"),
    ("atoms/atom-5-build-atoms-of-each-ksa-type.md",       "atom-5",    "5 · Build 3 atom types 🛠️",       "🙊 Phase 3 · do"),
    ("atoms/atom-6-design-the-assessment.md",              "atom-6",    "6 · Design the assessment 🛠️",     "🙊 Phase 3 · do"),
    ("atoms/atom-7-capstone-assemble-the-credential.md",   "atom-7",    "7 · Capstone 🚀",                 "🐵 Phase 4 · share"),
...
ATOM_IDS = ["atom-1", "atom-2", "atom-3", "atom-4", "atom-5", "atom-6", "atom-7"]

PATH2ID = {p[0]: p[1] for p in PAGES}          # course file path -> in-app page id
COURSE_REL = "examples/ada-methodology-designer-micro-credential"  # course root, relative to repo root
...
<title>🎓 ADA Methodology Designer · ADA Micro-Credential</title>
...
<div class="app">
  <aside class="side" id="side">
    <div class="brand">
      ...
      <div><b>ADA Methodology Designer</b><small>ADA MICRO-CREDENTIAL</small></div>
    </div>
    <div class="progwrap">
      <div class="progbar"><div class="progfill" id="progfill"></div></div>
      <div class="progtext" id="progtext">0 / 7 atoms complete</div>
    </div>
    <nav id="nav">{{NAV}}</nav>
  </aside>
  <div class="main">
    <div class="topbar">
      ...
      <span class="pill">🎓 ADA Methodology Designer</span>
      <span class="sp"></span>
...
(function(){
  ...
  var atomIds=["atom-1","atom-2","atom-3","atom-4","atom-5","atom-6","atom-7"];
  var idx=0;
  ...
  var KEY="ada-methodology-designer-progress";
